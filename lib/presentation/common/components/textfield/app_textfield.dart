...
class AppTextField extends StatefulWidget {
  ...
  AppTextField.number(
    ...
    this.inputFormatters!.add(NumberTextInputFormatter());
  }
...
class _AppTextFieldState extends State<AppTextField> {
  ...
  Widget _visibilityPasswordSuffix() {
    return IconButton(
      icon: SvgPicture.asset(
        _passwordVisible
            ? IconConstants.icVisibility
            : IconConstants.icVisibility_off,
      ),
      onPressed: () {
        setState(() {
  ...
  Widget build(BuildContext context) {
    final textStyle = Theme.of(context).textTheme.textContentTextField.copyWith(
        color: widget.errorText != null && widget.isRedTextWhenError
            ? mColorBad
            : null);
    final hintStyle = widget.isEnable
        ? Theme.of(context).textTheme.textHintTextField
        : textStyle;
          ...
          child: TextFormField(
            ...
            decoration: InputDecoration(
                ...
                enabledBorder: widget.inputBorder.copyWith(
                  borderSide: BorderSide(color: mColorBordersLines),
                ...
                errorBorder: widget.inputBorder.copyWith(
                  borderSide: BorderSide(color: mColorBad),
                )
                // style
                ),
          ),
